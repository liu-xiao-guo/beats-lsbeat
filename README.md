...
`${GOPATH}/src/github.com/liu-xiao-guo/lsbeat`
...
```
git remote set-url origin https://github.com/liu-xiao-guo/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/liu-xiao-guo/lsbeat
git clone https://github.com/liu-xiao-guo/lsbeat ${GOPATH}/src/github.com/liu-xiao-guo/lsbeat
```
